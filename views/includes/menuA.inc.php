  ...
  <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="../controlers/controlerCategoria.php?opcao=3">Cadastrar Veículo</a></li> <!-- Nova opção de cadastro -->
        ...
        <li><a class="dropdown-item" href="../controlers/controlerVeiculo.php?opcao=6">Show Room</a></li>
      </ul>
    </li>
